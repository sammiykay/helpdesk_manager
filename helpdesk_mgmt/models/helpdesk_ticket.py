...
class HelpdeskTicket(models.Model):
    ...
    def message_new(self, msg, custom_values=None):
        ...
        # Get the sender's email address from the msg object
        sender_email = msg.get("from")

        # Fetch the list of authorized emails from the database
        ...
        if sender_email.lower() in users_email:
            defaults = {
            ...
            # If the sender's email is not authorized, do nothing or handle accordingly
